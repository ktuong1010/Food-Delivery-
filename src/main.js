document.addEventListener('DOMContentLoaded', function() {
    ...
    tabs.forEach(tab => {
        tab.addEventListener('click', function() {
            ...
            //SAhow/hide content based on tab
    ...
    faqQuestions.forEach(question => {
        question.addEventListener('click', function() {
            ...
            if (questionText.includes('payment methods')) {
                faqAnswer.innerHTML = `
                    <div class="faq-card">
                        <img src="./assets/img/icons/credit-card.svg" alt="Credit Card" />
                        <h3>Credit & Debit Cards</h3>
                        <p>We accept all major credit and debit cards for payment</p>
                    </div>
                    <div class="faq-card">
                        <img src="./assets/img/icons/digital-wallet.svg" alt="Digital Wallet" />
                        <h3>Digital Wallets</h3>
                        <p>Pay easily with Apple Pay, Google Pay, and other digital wallets</p>
                    </div>
                    <div class="faq-card">
                        <img src="./assets/img/icons/cash.svg" alt="Cash" />
                ...
                faqAnswer.innerHTML = `
                    <div class="faq-card">
                        <img src="./assets/img/icons/track.svg" alt="Track Order" />
                        <h3>Real-time Tracking</h3>
                        <p>Watch your order's journey from restaurant to your doorstep in real-time</p>
                    </div>
                    <div class="faq-card">
                        <img src="./assets/img/icons/app.svg" alt="Mobile App" />
                        <h3>Mobile App</h3>
                ...
                faqAnswer.innerHTML = `
                    <div class="faq-card">
                        <img src="./assets/img/icons/promotion.svg" alt="Promotions" />
                        <h3>Special Promotions</h3>
                        <p>Regular discounts and promotional offers throughout the year</p>
                    </div>
                    <div class="faq-card">
                        <img src="./assets/img/icons/loyalty.svg" alt="Loyalty Program" />
                        <h3>Loyalty Program</h3>
                        <p>Earn points with every order and redeem them for discounts</p>
                    </div>
                    <div class="faq-card">
                        <img src="./assets/img/icons/referral.svg" alt="Referral" />
    ...
    if (searchForm) {
        searchForm.addEventListener('submit', function(e) {
            ...
            if (postcodeValue) {
                ...
                // 2. Send an API request to check service availability
                // 3. Redirect to results page or show restaurants
                ...
                if (postcodePattern.test(postcodeValue)) {
                    ...
                    // I will redirect or show results here
                } else {
    ...
    if (checkoutBtn) {
        checkoutBtn.addEventListener('click', function() {
            // This place for redirecting to checkout page
